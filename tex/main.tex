...
\title{\emph{Branch and Bound} e \emph{Backtracking}}
...
\section{Relação entre os algoritmos}
\subsection{\emph{Branch and Bound} e \emph{Backtracking}}
\import{sections/branchandBack}{semelhancasEdiferencas.tex}

\subsection{Abordagem gulosa, Programação Dinâmica e Divisão e Conquista}
\import{sections/branchandBack}{gulosaDinamicaEConquista.tex}
